...
//  $id = $row['RecipeID'];
  ...
  $statement_delete = $ConnectingDB->prepare($query_img_delete);
  $statement_delete->bindValue(':img', $img);
  $statement_delete->execute();

        // $query_delete_recipe = "DELETE img FROM Recipe WHERE RecipeID = $id LIMIT 1";
